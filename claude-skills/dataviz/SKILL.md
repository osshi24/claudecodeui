---
name: dataviz
description: Design-system-agnostic method for charts, dashboards, and data visualization — form heuristic, color formula with runnable validator, mark specs, and interaction rules.
source: Built-in skill của Claude Code (bundled), xuất nguyên văn từ phiên bản v2.1.226. Các file references/ và scripts/ đi kèm được copy nguyên bản trong cùng thư mục này.
---
